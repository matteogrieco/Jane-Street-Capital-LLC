Cette compétition demande de modéliser des flux de données financières complexes. 

Les défis de cette compétition sont : la présence de séries temporelles non stationnaires, des données anonymisées et des restrictions d’API
